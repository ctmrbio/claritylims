...
class TestLabelPrinter(object):
    def test_single_container__with_lims_id_as_barcode(self):
        ...
        assert contents == "^XA^LH0,0^FO10,5^BY3^BCN,30,N,N,N^FD123^FS^FO10,40^A0,32," \
                           "25^FB1009,4,20,^FDcontainer1^FS^XZ"
    ...
    def test_two_containers__with_lims_id_as_barcode(self):
        ...
        contents = label_printer.contents
        pyperclip.copy(contents)
        assert contents == "^XA^LH0,0^FO10,5^BY3^BCN,30,N,N,N^FD123^FS^FO10,40^A0,32,25^FB1009,4,20," \
                           "^FDcontainer1^FS^XZ\n" \
                           "^XA^LH0,0^FO10,5^BY3^BCN,30,N,N,N^FD124^FS^FO10,40^A0,32,25^FB1009,4,20," \
                           "^FDcontainer2^FS^XZ"
    ...
    def test_single_container__with_name_as_barcode(self):
        ...
        contents = label_printer.contents
        pyperclip.copy(contents)
        assert contents == "^XA^LH0,0^FO10,5^BY3^BCN,30,N,N,N^FDcontainer1^FS^FO10," \
                           "40^A0,32,25^FB778,4,20,^FDcontainer1^FS^XZ"
    ...
    def test_dmitry_barcode(self):
        ...
        contents = label_printer.contents
        pyperclip.copy(contents)
        assert contents == "^XA^LH0,0^FO10,5^BY3^BCN,30,N,N,N^FD7277^FS^FO10,40^A0," \
                           "32,25^FB976,4,20,^FD27-7277^FS^XZ"
    ...
    def test_with_long_container_name__lims_id_as_barcode(self):
        ...
        contents = label_printer.contents
        pyperclip.copy(contents)
        assert contents == "^XA^LH0,0^FO10,5^BY3^BCN,30,N,N,N^FD727789^FS^FO10," \
                           "40^A0,32,25^FB910,4,20,^FDCOVID_200416_RNA_144401.v1^FS^XZ"
    ...
    def test_with_long_container_name__name_as_barcode(self):
        ...
        contents = label_printer.contents
        pyperclip.copy(contents)
        assert contents == "^XA^LH0,0^FO10,5^BY3^BCN,30,N,N,N^FDCOVID_200416_PREXT_144401^FS^FO10," \
                           "40^A0,32,25^FB283,4,20,^FDCOVID_200416_PREXT_144401^FS^XZ"
